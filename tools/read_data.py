...
data_set = "./Params/me_train.json"
target = "./Params/train_questions_with_evidence.txt"
stopwords_dict = "./Params/stop_words_ch.txt"
...
with open(data_set, "r") as f, open(target, "w") as f2:
    ...
    for key, value in data.items():
        ...
        f2.write(" ".join(words) + "\n")
        for k, v in data[key]['evidences'].items():
